...
typedef enum une_token_type_ {
  ...
  #define UNE_R_BGN_KEYWORD_TOKENS UNE_TT_TRUE
  UNE_TT_TRUE,
  UNE_TT_FALSE,
  UNE_TT_VOID,
  UNE_TT_THIS,
  ...
  UNE_TT_LEQ,
  UNE_TT_LSS,
  #define UNE_R_END_CONDITION_TOKENS UNE_TT_LSS
  UNE_TT_NOT,
  ...
  #define UNE_R_BGN_ASSIGNMENT_TOKENS UNE_TT_SET
  UNE_TT_SET,
  UNE_TT_PLUSEQUAL,
  UNE_TT_MINUSEQUAL,
  UNE_TT_STARSTAREQUAL,
  UNE_TT_STAREQUAL,
  UNE_TT_SLASHSLASHEQUAL,
  UNE_TT_SLASHEQUAL,
  UNE_TT_PERCENTEQUAL,
  #define UNE_R_END_ASSIGNMENT_TOKENS UNE_TT_PERCENTEQUAL
