...
*/
#define UNE_ISTREAM_ARRAY_PULLER_VAL(                                                              \
    name__, type__, cast_type__, error_value__, verify_position__)                                 \
...
*/
#define UNE_ISTREAM_ARRAY_PULLER_REF(                                                              \
    name__, type__, cast_type__, error_value__, verify_position__)                                 \
    une_static__ type__ *name__(une_istream *istream)                                              \
    {                                                                                              \
        if (verify_position__ && !une_istream_array_verify_position(istream, 1)) {                 \
...
*/
#define UNE_ISTREAM_ARRAY_PEEKER_VAL(                                                              \
    name__, type__, cast_type__, error_value__, verify_position__)                                 \
...
*/
#define UNE_ISTREAM_ARRAY_PEEKER_REF(                                                              \
    name__, type__, cast_type__, error_value__, verify_position__)                                 \
    une_static__ type__ *name__(une_istream *istream, ptrdiff_t offset)                            \
    {                                                                                              \
        if (verify_position__ && !une_istream_array_verify_position(istream, offset))              \
...
*/
#define UNE_ISTREAM_ARRAY_ACCESS_VAL(                                                              \
    name__, type__, cast_type__, error_value__, verify_position__)                                 \
    une_static__ type__ name__(une_istream *istream)                                               \
    {                                                                                              \
...
*/
#define UNE_ISTREAM_ARRAY_ACCESS_REF(                                                              \
    name__, type__, cast_type__, error_value__, verify_position__)                                 \
    une_static__ type__ *name__(une_istream *istream)                                              \
    {                                                                                              \
        if (verify_position__ && istream->has_reached_end)                                         \
...
*/
#define UNE_ISTREAM_WFILE_ITEM__(istream__) istream__->data.wfile.wchar
